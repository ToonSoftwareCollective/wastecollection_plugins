//<provider>51</provider><version>1.0.0</version><parms>"ICSId"</parms>
//provider middelburgvlissingen.nl testdata: webcal://mijnafvalzaken.nl/ical/0383200000000001
	...
	function readCalendar(wasteZipcode, wasteHouseNr, extraDates, enableCreateICS, wasteICSId, wasteStreet, wasteStreetName, wasteCity, wasteFullICSUrl) {
		...
		xmlhttp.open("GET", "https://mijnafvalzaken.nl/ical/" + wasteICSId, true);
		xmlhttp.send();
	}
