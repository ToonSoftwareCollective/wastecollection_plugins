//<provider>55</provider><version>1.0.0</version><parms>"ICSId"</parms>
//provider voorschoten.nl testdata:https://afvalkalender.voorschoten.nl/ical/0626200000008448
	...
	function readCalendar(wasteZipcode, wasteHouseNr, extraDates, enableCreateICS, wasteICSId, wasteStreet, wasteStreetName, wasteCity, wasteFullICSUrl) {
		...
		xmlhttp.open("GET", "https://afvalkalender.voorschoten.nl/ical/" + wasteICSId, true);
		xmlhttp.send();
	}
