//<provider>47</provider><version>1.0.0</version><parms>"ICSId"</parms>
//provider lingewaard.nl testdata:https://afvalwijzer.lingewaard.nl/ical/1705200000110287
	...
	function readCalendar(wasteZipcode, wasteHouseNr, extraDates, enableCreateICS, wasteICSId, wasteStreet, wasteStreetName, wasteCity, wasteFullICSUrl) {
		...
		xmlhttp.open("GET", "https://afvalwijzer.lingewaard.nl/ical/" + wasteICSId, true);
		xmlhttp.send();
	}

	function wasteTypeCode(shortName) {
		switch (shortName) {
			case "Groent": return 3;
			case "Restaf": return 0;
			case "Oud pa": return 2;
