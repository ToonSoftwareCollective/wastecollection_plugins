//<provider>29</provider><version>1.0.0</version><parms>"zipcode,housenr"</parms>
//provider veldhoven.nl testdata:https://www.veldhoven.nl/afvalkalender/2021/5505RN-1.ics
	...
	function wasteTypeCode(shortName) {
		switch (shortName) {
			...
			case "PMD-za": return 1;
			case "Chemok": return 7;
			default: break;
		}
		return "?";
	}
