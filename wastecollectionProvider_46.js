//<provider>46</provider><version>1.0.0</version><parms>"zipcode,housenr"</parms>
//provider waardlanden.nl testdata: 4207GR 5
	...
	function readCalendar(wasteZipcode, wasteHouseNr, extraDates, enableCreateICS, wasteICSId, wasteStreet, wasteStreetName, wasteCity, wasteFullICSUrl) {
       		...
       		var params = "companyCode=942abcf6-3775-400d-ae5d-7380d728b23c&postCode=" + wasteZipcode + "&houseNumber=" + wasteHouseNr + "&houseLetter=&houseNumberAddition=";
	...
	function read2goMobileCalendar(uniqueId) {
		...
		var params = "companyCode=942abcf6-3775-400d-ae5d-7380d728b23c&uniqueAddressId=" + uniqueId + "&startDate=" + startDate + "&endDate=" + endDate;
