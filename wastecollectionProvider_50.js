//<provider>50</provider><version>1.0.0</version><parms>"zipcode,housenr"</parms>
//goes.nl   https://afvalkalender.goes.nl/2022/4461VM-85.ics
	...
	function readCalendar(wasteZipcode, wasteHouseNr, extraDates, enableCreateICS, wasteICSId, wasteStreet, wasteStreetName, wasteCity, wasteFullICSUrl) {
		...
		var wasteYear = vandaag.getFullYear();

		console.log("JOOP:"+ wasteYear + "-" + "https://afvalkalender.goes.nl/" + wasteYear + "/" + wasteZipcode + "-" + wasteHouseNr + ".ics");
		...
		xmlhttp.onreadystatechange=function() {
 		...
 		xmlhttp.open("GET", "https://afvalkalender.goes.nl/" + wasteYear + "/" + wasteZipcode + "-" + wasteHouseNr + ".ics", true);
		xmlhttp.send();
	}
